...
public class GUI extends JFrame {
    ...
    private BasicStroke trackStroke = new BasicStroke(8, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10, new float[]{8}, 0);
    ...
    public GUI() {
        ...
        TrainGoalElement[] trainGoalElements = {new TrainGoalElement(new Rect(-490, Screen.HEIGHT - 620, 900, 150)),
                new TrainGoalElement(new Rect(-490, Screen.HEIGHT - 413, 900, 150)), new TrainGoalElement(new Rect(-490, Screen.HEIGHT - 207, 900, 150))};
        for (int i = 0; i < 3; i++) {
